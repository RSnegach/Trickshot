...
## Corpus Check
- 143 files · ~666,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3071 nodes · 7584 edges · 153 communities (134 shown, 19 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 678 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74b8b5f5`
...
Cohesion: 0.05
Nodes (14): GoalFrame, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns (+6 more)
...
Cohesion: 0.05
Nodes (31): ActiveRagdoll, AimReticle, AnimState, BallController, BodyState, bool, Camera, Crosser (+23 more)
...
Cohesion: 0.14
Nodes (9): bool, float, Func, int, Quaternion, Vector3, Band, Goalkeeper (+1 more)
...
Cohesion: 0.15
Nodes (13): Action, GUIStyle, Rect, GUIStyle, Color, GUIStyle, int, Rect (+5 more)
...
### Community 47 - ".Box"
Cohesion: 0.10
Nodes (15): AccuracyBoard, AnimState, int, NetSession, QuickChatFeed, ReplaySystem, SaveWatch, string (+7 more)
...
Cohesion: 0.08
Nodes (11): StatRow, Dictionary, string, ChatCensor, float, int, List, Queue (+3 more)
...
Cohesion: 0.14
Nodes (9): byte, Vector2, GameInput, Action, Action, MultiplayerHubUI, InputActionAsset, InputActionMap (+1 more)
...
Cohesion: 0.06
Nodes (16): InputFrame, Texture2D, Bar, bool, Camera, float, int, Material (+8 more)
...
### Community 87 - "Bone"
Cohesion: 0.09
Nodes (24): ActiveRagdoll, AimReticle, BallController, bool, Camera, Crosser, GameCamera, GameInput (+16 more)
...
Cohesion: 0.12
Nodes (8): Material, Transform, DecorTint, Vector3, Bone, RagdollPose, bone, euler
...
Cohesion: 0.08
Nodes (17): AnimState, Quaternion, bool, Bounds, byte, Collider, ConfigurableJoint, Dictionary (+9 more)
...
Cohesion: 0.24
Nodes (5): bool, int, MenuUI, Phase, Phase
...
Cohesion: 0.30
Nodes (6): Color, Material, Texture2D, JerseyFaces, Make, Shader
...
Cohesion: 0.08
Nodes (10): Vector2, IStrikerInput, IPlayerController, bool, Collider, float, Vector3, Striker (+2 more)

### Community 105 - "AccuracyBoard"
Cohesion: 0.21
Nodes (9): bool, float, string, BodyPlan, HeaderAction, SpeciesAxis, SpeciesBias, SpeciesDef (+1 more)
...
### Community 133 - ".Box"
Cohesion: 0.47
Nodes (3): GameObject, Transform, Vector3
...
### Community 136 - "JerseyDesigns.Nations1.cs"
Cohesion: 0.22
Nodes (7): BallController, Camera, GameCamera, GameInput, Material, Transform, NetAccuracyMatch

### Community 138 - "KickDetector"
Cohesion: 0.25
...
### Community 143 - ".BuildScene"
Cohesion: 0.29
Nodes (3): Color, Material, PhysicsMaterial
...
## Knowledge Gaps
- **178 isolated node(s):** `Phase`, `Reason`, `Phase`, `SetPieceSpin`, `Emote` (+173 more)
...
- **Why does `Trickshot` connect `AccuracyGame` to `Jersey / Nation Designs`, `Dribble System`, `Net Messages & Wire Codec`, `Input & Keybinds`, `Goalkeeper AI & Control`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `BodyLayoutDef`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `Bone`, `.Box`, `.OnGUI`, `Celebration`, `SkillTree`, `Footballer`, `SteamTransport`, `com.unity.modules.jsonserialize`, `INetTransport`, `.ClientUpdate`, `Dribble`, `Footballer`, `.Configure`, `PitchBuilder`, `.Empty`, `NetCodec`, `Footballer`, `Crowd`, `SessionBrowserUI`, `.Empty`, `.Box`, `Goalkeeper`, `.SetLocalInput`, `.Build`, `GameInput`, `QuickChat`, `IStrikerInput`, `MenuUI`, `SimConfig`, `SimConfig`, `CrosserBubble`, `AccuracyGame`, `QuickChat`, `com.unity.modules.adaptiveperformance`, `MenuUI`, `.PhysMat`, `JerseyDesigns.Nations10.cs`, `StadiumStyle`, `.Set`, `DefensiveWall`, `CrosserControl`, `Role.cs`, `.StartRebind`, `.Begin`, `FreeplayGame`, `SessionBrowserUI`, `.StartRebind`, `BoneSpec`, `AccuracyBoard`, `JerseyDesigns.Nations4.cs`, `.Set`, `.Update`, `Turf`, `.ListLobbies`, `.AttachKickDetectors`, `StadiumSelectUI`, `.ListLobbies`, `.BuildFootballer`, `MenuUI`, `Goal`, `AssetImportRules`, `.Set`, `.OptionGrid`, `JerseyDesigns.Nations6.cs`, `JerseyDesigns.Nations1.cs`, `KickDetector`, `GameMode`, `JerseyDesigns.Nations5.cs`, `JerseyDesigns.Nations6.cs`, `CrosserBubble`?**
  _High betweenness centrality (0.203) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `NetPump` to `Dribble System`, `Net Messages & Wire Codec`, `Input & Keybinds`, `.Box`, `AccuracyGame`, `LobbyUI`, `KickDetector`, `BodyLayoutDef`, `PrematchUI`, `Bone`, `CrosserBubble`, `com.unity.modules.jsonserialize`, `INetTransport`, `Footballer`, `.Configure`, `NetCodec`, `Footballer`, `Crowd`, `.SetLocalInput`, `GameInput`, `QuickChat`, `IStrikerInput`, `MenuUI`, `SimConfig`, `AccuracyGame`, `Snapshot`, `MenuUI`, `.PhysMat`, `JerseyDesigns.Nations10.cs`, `DefensiveWall`, `CrosserControl`, `Role.cs`, `.Begin`, `.StartRebind`, `BoneSpec`, `AccuracyBoard`, `Species`, `.LaunchBandDive`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `CustomizeUI` connect `Ball Physics & Launch` to `Jersey / Nation Designs`, `NetCodec`, `Goalkeeper AI & Control`, `AccuracyGame`, `SessionBrowserUI`, `Goalkeeper`, `.OnGUI`, `GameInput`, `Dribble`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **What connects `Phase`, `Reason`, `Phase` to the rest of the system?**
