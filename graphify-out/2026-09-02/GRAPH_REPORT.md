...
## Corpus Check
- 180 files · ~1,923,639 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4755 nodes · 10999 edges · 247 communities (233 shown, 13 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 959 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b123e280`
...
1. `ActiveRagdoll` - 208 edges
2. `NetSession` - 143 edges
3. `Trickshot` - 140 edges
...
### Community 0 - "PeerId"
Cohesion: 0.12
Nodes (5): PeerId, IsValid, JerseyChunkMsg, JerseyRx, IEquatable
...
Cohesion: 0.11
Nodes (27): AccessoryEntry, Action, Collider, HairDef, IReadOnlyList, List, Material, Mesh (+19 more)

### Community 10 - ".BuildSpiky"
Cohesion: 0.16
Nodes (19): Func, HairDef, Color, Func, GameObject, List, Material, Mesh (+11 more)
...
Cohesion: 0.09
Nodes (12): Action, MatchModeUI, Action, MultiplayerHubUI, Action, OtherModesUI, GameObject, Light (+4 more)
...
Cohesion: 0.07
Nodes (24): Bounds, ConfigurableJoint, Dictionary, IReadOnlyList, List, PhysicsMaterial, Quaternion, Vector3 (+16 more)

### Community 23 - "NetSession"
Cohesion: 0.04
Nodes (43): appr, LobbySlot, NetRole, Crosser, Keeper, Shooter, Spectator, Dictionary (+35 more)
...
Cohesion: 0.08
Nodes (14): Body, List, Material, Rigidbody, ShootoutState, Snapshot, Transform, Vector3 (+6 more)
...
Cohesion: 0.08
Nodes (15): Queue, CallLimiter, Bar, List, Vector3, Bar, AnyArmed, Option (+7 more)

### Community 30 - "NetStrikerMatch"
Cohesion: 0.06
Nodes (17): InputFrame, Texture2D, Goalkeeper, ai, Crosser, List, Material, name (+9 more)
...
### Community 34 - "MeshGen"
Cohesion: 0.22
Nodes (6): Func, Mesh, Quaternion, Vector2, Vector3, MeshGen

### Community 35 - "CustomizeUI"
Cohesion: 0.09
Nodes (17): Action, Dictionary, Func, GUIStyle, IEnumerator, Rect, Texture2D, Vector2 (+9 more)
...
Cohesion: 0.09
Nodes (12): Vector3, AccuracyGame, Phase, Armed, Cooldown, Live, IReadOnlyList, List (+4 more)
...
Cohesion: 0.10
Nodes (23): ai, Color, GUIStyle, List, name, Rect, slot, Vector2 (+15 more)

### Community 46 - "FreeKickGame"
Cohesion: 0.15
Nodes (9): Collider, Random, Vector3, FreeKickGame, Phase, Armed, Cooldown, Live (+1 more)

### Community 47 - "SetPieceTaker"
Cohesion: 0.12
Nodes (14): Quaternion, Vector2, SetPieceTaker, Active, ChargeHeld, CurlAxis, Done, HasCharged (+6 more)

### Community 48 - "HairSim"
Cohesion: 0.14
Nodes (14): Material, Matrix4x4, Mesh, MeshFilter, MeshRenderer, Transform, Vector2, Vector3 (+6 more)

### Community 49 - ".Build"
Cohesion: 0.16
Nodes (9): BoxCollider, CapsuleCollider, Collider, Material, Rigidbody, SphereCollider, Color, PlayerAppearance (+1 more)
...
Cohesion: 0.08
Nodes (10): Func, Transform, Bar, Material, Refs, Snapshot, Transform, Vector3 (+2 more)
...
Cohesion: 0.08
Nodes (35): Action, Rect, Action, Rect, GUIStyle, Action, GUIStyle, Rect (+27 more)

### Community 68 - ".Draw"
Cohesion: 0.10
Nodes (17): Color, GUIStyle, List, MatchStatsUI, Tab, Away, Home, Matrix4x4 (+9 more)
...
Cohesion: 0.08
Nodes (20): Collider, Transform, CrosserBubble, Func, Vector3, CrosserControl, Acc01, InStance (+12 more)
...
### Community 91 - ".ShellRadius"
Cohesion: 0.21
Nodes (7): Func, Vector3, HairShape, ShellParams, Decal, Comb, ShellParams
...
Cohesion: 0.13
Nodes (13): Collider, Color, Light, List, Material, MeshFilter, MeshRenderer, PhysicsMaterial (+5 more)
...
Cohesion: 0.22
Nodes (9): AnimState, Dive, Down, Idle, Jump, Kick, KickL, Run (+1 more)
...
Cohesion: 0.16
Nodes (6): Vector2, BodyState, InputFrame, Snapshot, StampedSnap, Sticky
...
### Community 123 - "Striker"
Cohesion: 0.26
Nodes (4): Striker, KickDetector, Rigidbody, Rigidbody
...
Cohesion: 0.10
Nodes (16): Vector3, GameCamera, BallCam, KeeperLookDownFraction, KeeperLookYaw, Pitch, SlowMoActive, Yaw (+8 more)
...
### Community 150 - "SettingsMenu"
Cohesion: 0.17
Nodes (6): QuickChat, Slots, RebindingOperation, Vector2, SettingsMenu, IsRebinding

### Community 151 - "NetMessages.cs"
Cohesion: 0.15
Nodes (8): JoinRefusal, MatchRunning, None, NoSlot, Version, MatchConfig, ShootoutState, StatRow
...
### Community 159 - "face_props_jewelry"
Cohesion: 0.12
...
### Community 179 - ".Begin"
Cohesion: 0.21
Nodes (5): Action, Func, Vector3, Commit, SetPieceSpin

### Community 180 - "StudioSplash"
Cohesion: 0.38
Nodes (3): Action, GUIStyle, StudioSplash

### Community 181 - "RootMode"
Cohesion: 0.17
Nodes (12): RootMode, BackCluster, Crown, Explicit, FrontHairline, FrontSweep, Hairline, Ring (+4 more)
...
### Community 230 - "horse_markings_tack"
Cohesion: 0.18
...
## Knowledge Gaps
- **1565 isolated node(s):** `ZipEnabled`, `id`, `title`, `author`, `author_slug` (+1560 more)
...
- **Why does `Trickshot` connect `Trickshot` to `JerseyDesigns`, `SimConfig`, `Dribble`, `SetPieceMap`, `SkillTree`, `Cosmetics`, `AdultQuiz`, `Species`, `CareerStats`, `Bone`, `MenuIcons`, `PitchLayout`, `GameBootstrap`, `BuildAll`, `MatchProbe`, `PauseMenu`, `Passing`, `BodyLayoutDef`, `AnatomySim`, `KeeperGame`, `AccuracyGame`, `QuickChatFeed`, `CosmeticGallery`, `CrossMap`, `FreeKickGame`, `SetPieceTaker`, `HairSim`, `.Build`, `SkyDome`, `.Mount`, `AccuracyTarget`, `MatchGame`, `IStrikerInput`, `Make`, `Sniper`, `GameMode`, `.Draw`, `PrematchUI`, `KeeperHands`, `Multiplayer`, `DisplaySettings`, `Footballer`, `StatRadar`, `CrosserControl`, `.Pose`, `.ShellRadius`, `PlayerPreview`, `.Label`, `Knockdown`, `.Build`, `.RequestFriendsList`, `.Build`, `.Build`, `MonoBehaviour`, `.SetPoseOverride`, `MenuBackground`, `Turf`, `StadiumStyle`, `FlexNet`, `AudioManager`, `Playlist`, `.Box`, `.BuildGoal`, `TitleGlyph`, `AssetImportRules`, `.Set`, `.Place`, `.SlotSubMenu`, `Striker`, `.DriveTowardRotation`, `UIFont`, `GameCamera`, `GameInput`, `Crosser`, `Achievements`, `ShotType`, `SettingsMenu`, `Role`, `Goal`, `NotificationToastUI`, `AtomicFileWriter`, `CrosserSetupMsg`, `Keybinds`, `StudioSplash`, `Celebration`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `ActiveRagdoll` to `SimConfig`, `Dribble`, `Trickshot`, `Striker`, `.BuildSpiky`, `Cosmetics`, `Species`, `Goalkeeper`, `Bone`, `Crosser`, `.Mat`, `NetSetPieceMatch`, `Passing`, `NetStrikerMatch`, `BodyLayoutDef`, `KeeperController`, `AnatomySim`, `KeeperGame`, `AccuracyGame`, `CosmeticGallery`, `FreeKickGame`, `SetPieceTaker`, `HairSim`, `.Build`, `.Begin`, `NetMatch`, `MatchGame`, `Sniper`, `KeeperHands`, `Footballer`, `CrosserControl`, `.Pose`, `PlayerPreview`, `Hud`, `Knockdown`, `Celebration`, `MonoBehaviour`, `.SetPoseOverride`, `MenuBackground`, `BallController`, `EmotePose`, `Striker`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `NetSession` connect `NetSession` to `PeerId`, `.Label`, `Color32`, `Trickshot`, `QuickChatFeed`, `CrosserSetupMsg`, `Multiplayer`, `.RouteMessage`, `InputFrame`, `GameBootstrap`, `NetMatch`, `NetMessages.cs`, `MsgType`, `INetTransport`, `NetSetPieceMatch`, `NetStrikerMatch`?**
