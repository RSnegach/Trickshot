...
## Corpus Check
- 103 files · ~219,932 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2123 nodes · 3655 edges · 479 communities (63 shown, 416 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 278 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `81f820e1`
...
## Communities (479 total, 416 thin omitted)
...
Cohesion: 0.06
Nodes (12): IStrikerInput, NetInputSource, BallController, SetPieceSpin, KeeperController, State, SetPieceTaker, State (+4 more)
...
Cohesion: 0.09
Nodes (11): bool, float, int, Vector3, Delivery, ScrimRole, SimConfig, CrosserControl (+3 more)
...
Cohesion: 0.08
Nodes (14): Camera, Color, float, int, Light, List, Material, Quaternion (+6 more)

### Community 14 - "OptionsMenu"
Cohesion: 0.12
Nodes (5): LobbySlot, JerseyRx, NetSession, StampedSnap, StampedSnap
...
Cohesion: 0.24
Nodes (5): BodyState, MatchConfig, MsgType, Snapshot, ushort
...
## Knowledge Gaps
- **246 isolated node(s):** `LobbyInfo`, `StampedSnap`, `JerseyRx`, `Pending`, `SetPieceSpin` (+241 more)
...
- **Why does `Trickshot` connect `AccuracyGame` to `Ball Physics & Launch`, `Jersey / Nation Designs`, `Dribble System`, `Net Messages & Wire Codec`, `Input & Keybinds`, `Goalkeeper AI & Control`, `Net Set-Piece Match`, `GameBootstrap`, `Bone`, `Striker`, `CustomizeUI`, `GameCamera`, `Celebration`, `KeeperGame`, `DirectIpTransport.cs (direct-IP UDP)`, `NetSetPieceMatch`, `INetTransport`, `com.unity.modules.imgui`, `NetReader`, `LobbyUI`, `.Build`, `MonoBehaviour`, `Bone`, `dependencies`, `com.unity.modules.assetbundle`, `GameManager`, `chk.py`, `com.unity.modules.unitywebrequest`, `TimeTrialGame`, `.Configure`, `com.unity.modules.terrain`, `.Set`, `com.unity.modules.adaptiveperformance`, `com.unity.modules.wind`, `Kyrgyz Sun Emblem (kyrgyz_sun.png)`, `com.unity.modules.wind`, `Knockdown`, `.Set`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `NetStrikerMatch` connect `Direct IP Transport` to `Dribble System`, `Net Messages & Wire Codec`, `AccuracyGame`, `Kick Detection / Ragdoll Wiring`, `Net Set-Piece Match`, `Bone`, `OptionsMenu`, `com.unity.modules.assetbundle`, `GameManager`, `Kyrgyz Sun Emblem (kyrgyz_sun.png)`, `DirectIpTransport.cs (direct-IP UDP)`, `com.unity.modules.jsonserialize`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `Trickshot.Net` connect `AccuracyGame` to `Input & Keybinds`, `SkillTree`, `PlayerPreview`, `Crowd`, `OptionsMenu`, `com.unity.modules.uielements`, `Kyrgyz Sun Emblem (kyrgyz_sun.png)`, `LocalTransport`, `LobbySlot`, `ReliableChannel`?**
