# Graph Report - Trickshot  (2026-08-27)

## Corpus Check
- 136 files · ~575,358 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2834 nodes · 7424 edges · 135 communities (123 shown, 12 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 840 edges (avg confidence: 0.8)
...
Cohesion: 0.13
Nodes (3): PeerId, PlayerAppearance, IEquatable
...
Cohesion: 0.06
Nodes (11): JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, Role (+3 more)
...
Cohesion: 0.05
Nodes (38): bool, float, int, string, Vector3, BodyLayout, BodyLayoutDef, BoneSpec (+30 more)
...
Cohesion: 0.17
Nodes (8): bool, float, Func, Quaternion, Vector3, Goalkeeper, State, State
...
### Community 26 - ".Join"
Cohesion: 0.08
Nodes (11): Camera, Color, float, int, Light, List, Material, Quaternion (+3 more)
...
Cohesion: 0.06
Nodes (22): float, Material, Transform, Vector3, AimReticle, bool, float, Quaternion (+14 more)
...
### Community 47 - ".Box"
Cohesion: 0.13
Nodes (8): Action, bool, Dictionary, Func, List, Queue, ulong, LocalTransport
...
Cohesion: 0.13
Nodes (8): Action, Func, int, List, string, ulong, INetTransport, LobbyInfo
...
Cohesion: 0.08
Nodes (14): InputFrame, Bar, bool, Camera, float, int, Material, Refs (+6 more)
...
### Community 78 - ".Tick"
Cohesion: 0.13
Nodes (10): Delivery, ScrimRole, bool, Color, float, int, Vector3, Delivery (+2 more)
...
Cohesion: 0.07
Nodes (16): bool, byte, Collider, ConfigurableJoint, Dictionary, float, IReadOnlyList, List (+8 more)
...
### Community 121 - "MultiplayerHubUI"
Cohesion: 0.40
...
### Community 126 - "JerseyDesigns.Nations7.cs"
Cohesion: 0.20
Nodes (3): JerseyDesigns, JerseyDesigns, JerseyDesigns
...
### Community 137 - "MultiplayerHubUI"
Cohesion: 0.14
...
- **Why does `Trickshot` connect `AccuracyGame` to `Knockdown`, `AssetImportRules`, `Jersey / Nation Designs`, `Net Messages & Wire Codec`, `Dribble System`, `.Pose`, `Goalkeeper AI & Control`, `MultiplayerHubUI`, `LobbyUI`, `Net Set-Piece Match`, `BodyLayoutDef`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `Bone`, `.Box`, `.OnGUI`, `Celebration`, `SkillTree`, `Footballer`, `SteamTransport`, `.Join`, `com.unity.modules.jsonserialize`, `INetTransport`, `Dribble`, `.Configure`, `.Empty`, `NetCodec`, `.Configure`, `Footballer`, `.Empty`, `Goalkeeper`, `ShotServer`, `GameInput`, `QuickChat`, `IStrikerInput`, `MenuUI`, `com.unity.modules.ui`, `CrosserBubble`, `com.unity.modules.adaptiveperformance`, `.Tick`, `MenuUI`, `.PhysMat`, `KickDetector`, `StadiumStyle`, `.Set`, `MenuUI`, `Goal`, `.StartRebind`, `.Begin`, `.Build`, `HostSetupUI`, `SessionBrowserUI`, `StatRadar`, `AccuracyBoard`, `JerseyDesigns.Nations4.cs`, `.Set`, `JerseyDesigns.Nations2.cs`, `Turf`, `.ListLobbies`, `JerseyDesigns.Nations6.cs`, `SimConfig`, `.SetDribbleCarrier`, `.ListLobbies`, `MultiplayerHubUI`, `.TabBtn`, `.ListLobbies`, `JerseyDesigns.Nations7.cs`, `MenuUI`?**
  _High betweenness centrality (0.187) - this node is a cross-community bridge._
- **Why does `NetSession` connect `PlayerAppearance` to `Input & Keybinds`, `QuickChat`, `Goalkeeper AI & Control`, `Snapshot`, `SessionBrowserUI`, `.Heavy`, `JerseyDesigns.Nations10.cs`, `.SetLocalInput`, `.Build`, `.Set`, `NetSetPieceMatch`, `SimConfig`, `.ClientUpdate`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `CustomizeUI` connect `Ball Physics & Launch` to `Jersey / Nation Designs`, `NetCodec`, `Goalkeeper AI & Control`, `AccuracyGame`, `MultiplayerHubUI`, `SessionBrowserUI`, `BodyLayoutDef`, `MenuUI`?**
