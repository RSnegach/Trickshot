...
## Corpus Check
- 108 files · ~235,206 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2076 nodes · 4455 edges · 325 communities (70 shown, 255 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 572 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7856941d`
...
## Communities (325 total, 255 thin omitted)
...
Cohesion: 0.08
Nodes (17): Action, bool, Delivery, float, int, ScrimRole, string, Vector3 (+9 more)
...
Cohesion: 0.16
Nodes (10): bool, float, int, string, Transform, uint, Vector3, Body (+2 more)
...
Cohesion: 0.15
Nodes (7): PhysicsMaterial, Refs, PhysicsMaterial, Arena, Refs, ScrimmageArena, PhysicsMaterialCombine
...
Cohesion: 0.08
Nodes (13): Texture2D, Camera, Material, Camera, Material, Transform, Camera, Material (+5 more)

### Community 46 - "ReplaySystem"
Cohesion: 0.14
Nodes (4): IEnumerator, Rect, Vector2, Preset

### Community 47 - ".Box"
Cohesion: 0.12
Nodes (6): Rigidbody, bone, IStrikerInput, Striker, Trick, Trick

### Community 49 - ".Configure"
Cohesion: 0.24
Nodes (15): bool, byte, float, string, uint, Vector3, BodyState, InputFrame (+7 more)
...
### Community 105 - ".Set"
Cohesion: 0.21
Nodes (6): Material, Quaternion, Transform, Vector3, Bone, ColliderKind
...
- **Why does `Trickshot` connect `AccuracyGame` to `Jersey / Nation Designs`, `Dribble System`, `Goalkeeper AI & Control`, `Net Set-Piece Match`, `SkillIcons`, `SetPieceTaker`, `OptionsMenu`, `Bone`, `Striker`, `CustomizeUI`, `Celebration`, `SkillTree`, `SteamTransport`, `NetSetPieceMatch`, `com.unity.modules.jsonserialize`, `INetTransport`, `BallController`, `Footballer`, `.Build`, `.Empty`, `Dribble`, `PlayerPreview`, `Crosser`, `Multiplayer`, `.Box`, `GameCamera`, `MenuBackground`, `.Cylinder`, `QuickChat`, `.Box`, `Crowd`, `ChatCensor`, `DefensiveWall`, `AccuracyGame`, `com.unity.modules.adaptiveperformance`, `.ResetTo`, `Goalkeeper`, `Multiplayer`, `Vector2`, `com.unity.modules.wind`, `OptionsMenu`, `.Set`, `IPlayerController`, `PauseMenu`, `.DrawKeybindings`, `StadiumStyle`, `Crowd`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `NetSession` connect `Net Messages & Wire Codec` to `NetCodec`, `Direct IP Transport`, `Kick Detection / Ragdoll Wiring`, `.SafeEncode`, `.ClientUpdate`, `.ResetTo`, `Bone`, `.Configure`, `com.unity.modules.imageconversion`, `KeeperGame`, `.SetLocalInput`, `INetTransport`, `Footballer`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `PrematchUI` to `Dribble System`, `Kick Detection / Ragdoll Wiring`, `SkillIcons`, `SetPieceTaker`, `GameCamera`, `SkillTree`, `KeeperGame`, `SteamTransport`, `NetStrikerMatch`, `NetSetPieceMatch`, `com.unity.modules.jsonserialize`, `BallController`, `Footballer`, `Crosser`, `.SafeEncode`, `.ClientUpdate`, `.Box`, `MenuBackground`, `.Set`?**
