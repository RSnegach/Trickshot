...
## Corpus Check
- 144 files · ~667,935 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3035 nodes · 7816 edges · 145 communities (135 shown, 10 thin omitted)
...
Cohesion: 0.11
Nodes (13): Action, bool, int, label, string, CareerStatsUI, Cat, int (+5 more)
...
### Community 20 - ".OnGUI"
Cohesion: 0.06
Nodes (22): bool, Camera, float, Func, Transform, Vector3, GameCamera, Mode (+14 more)
...
Cohesion: 0.21
Nodes (3): string, CareerStats, CareerStatsData
...
Cohesion: 0.16
Nodes (5): Vector2, IStrikerInput, Texture2D, Material, Texture2D
...
Cohesion: 0.17
Nodes (9): Action, GUIStyle, int, RebindingOperation, Rect, string, Vector2, OptionsMenu (+1 more)
...
### Community 141 - ".Tick"
Cohesion: 0.06
Nodes (16): IPlayerController, Collision, float, KickDetector, Rigidbody, Rigidbody, Rigidbody, bool (+8 more)
...
- **Why does `Trickshot` connect `AccuracyGame` to `ChatCensor`, `AssetImportRules`, `Jersey / Nation Designs`, `Net Messages & Wire Codec`, `Input & Keybinds`, `Dribble System`, `Goalkeeper AI & Control`, `.DriveTowardRotation`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `Goal`, `SetPieceTaker`, `.Tick`, `PrematchUI`, `Bone`, `ChatCensor`, `.Box`, `.Mul`, `Footballer`, `SteamTransport`, `.Join`, `com.unity.modules.jsonserialize`, `INetTransport`, `Dribble`, `Footballer`, `.Configure`, `PitchBuilder`, `.Empty`, `NetCodec`, `.Configure`, `Footballer`, `Vector3`, `SessionBrowserUI`, `.Empty`, `.Box`, `Goalkeeper`, `.SetLocalInput`, `Bone`, `.Build`, `GameInput`, `SimConfig`, `com.unity.modules.ui`, `AccuracyGame`, `com.unity.modules.adaptiveperformance`, `SetPieceMap`, `.Heavy`, `TimeTrialGame`, `JerseyDesigns.Nations10.cs`, `MultiplayerHubUI`, `Bone`, `Action`, `MenuUI`, `.SetPoseOverride`, `CrosserControl`, `FlexNet`, `.Begin`, `FreeplayGame`, `.AttachKickDetectors`, `SessionBrowserUI`, `.Build`, `IPlayerController`, `BoneSpec`, `Color`, `JerseyDesigns.Nations4.cs`, `.Set`, `.Update`, `Turf`, `.ListLobbies`, `ShotServer`, `QuickChat`, `.BuildScene`, `.Divider`, `.BuildFootballer`, `.Pose`?**
  _High betweenness centrality (0.206) - this node is a cross-community bridge._
- **Why does `NetSession` connect `SkillTree` to `.SnapFacing`, `List`, `NetSetPieceMatch`, `.SetLocalInput`, `ShotServer`, `.Update`, `.SetLocalInput`, `CustomizeUI`, `NetPump`, `.OnGUI`, `.Box`, `.Set`, `MenuUI`, `Goal`, `.ClientUpdate`, `.Build`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `Celebration` to `.TickNetPass`, `Net Messages & Wire Codec`, `Input & Keybinds`, `.ClearPoseOverrides`, `.Rebuild`, `.DriveTowardRotation`, `AccuracyGame`, `LobbyUI`, `Bone`, `.Tick`, `OptionsMenu`, `PrematchUI`, `.OnGUI`, `.Join`, `NetSetPieceMatch`, `INetTransport`, `.ClientUpdate`, `Dribble`, `Footballer`, `.Empty`, `.Box`, `Goalkeeper`, `.SetLocalInput`, `GameInput`, `IStrikerInput`, `MenuUI`, `SimConfig`, `.SlotSubMenu`, `MenuUI`, `.SetPoseOverride`, `CrosserControl`, `Role.cs`, `FlexNet`, `.Begin`, `.Build`, `.Update`, `ShotServer`, `.BuildFootballer`?**
