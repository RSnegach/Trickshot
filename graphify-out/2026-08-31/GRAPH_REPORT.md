...
## Corpus Check
- 145 files · ~669,059 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3063 nodes · 7938 edges · 149 communities (129 shown, 20 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 857 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `82b7075e`
...
Cohesion: 0.08
Nodes (7): JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, ShotType, Trickshot.Net, Trickshot
...
Cohesion: 0.06
Nodes (20): Rect, Vector2, bool, Camera, float, GameObject, int, Light (+12 more)
...
### Community 47 - ".Box"
Cohesion: 0.14
Nodes (14): Material, bool, float, int, string, Vector3, BodyLayout, BodyLayoutDef (+6 more)

### Community 48 - "Goalkeeper"
Cohesion: 0.11
Nodes (9): float, int, Matrix4x4, MenuScale, Action, bool, int, MenuUI (+1 more)
...
### Community 59 - "MenuUI"
Cohesion: 0.06
Nodes (26): bool, byte, Color, float, int, label, string, Texture2D (+18 more)
...
Cohesion: 0.17
Nodes (11): PhysicsMaterial, PhysicsMaterial, float, int, Material, PhysicsMaterial, Transform, Vector3 (+3 more)
...
Cohesion: 0.06
Nodes (22): Collider, float, Transform, CrosserBubble, Rigidbody, Rigidbody, Rigidbody, bool (+14 more)
...
Cohesion: 0.07
Nodes (17): JoinRefusal, NetRole, Snapshot, bool, byte, Dictionary, float, HashSet (+9 more)
...
### Community 126 - ".Set"
Cohesion: 0.14
Nodes (7): Collision, Transform, Vector3, Bone, RagdollPose, bone, euler
...
- **Why does `Trickshot` connect `AccuracyGame` to `Ball Physics & Launch`, `Jersey / Nation Designs`, `Dribble System`, `Net Messages & Wire Codec`, `Input & Keybinds`, `Goalkeeper AI & Control`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `Bone`, `.Box`, `Celebration`, `SkillTree`, `Footballer`, `SteamTransport`, `NetSetPieceMatch`, `com.unity.modules.jsonserialize`, `INetTransport`, `Dribble`, `Footballer`, `.Configure`, `PitchBuilder`, `.Empty`, `NetCodec`, `.Configure`, `Footballer`, `SessionBrowserUI`, `.Box`, `Goalkeeper`, `.SetLocalInput`, `.Build`, `MenuUI`, `SimConfig`, `.SlotSubMenu`, `com.unity.modules.ui`, `CrosserBubble`, `AccuracyGame`, `com.unity.modules.adaptiveperformance`, `Snapshot`, `.Heavy`, `TimeTrialGame`, `JerseyDesigns.Nations10.cs`, `MultiplayerHubUI`, `Bone`, `Action`, `DefensiveWall`, `CrosserControl`, `NetPump`, `.Begin`, `FreeplayGame`, `.AttachKickDetectors`, `SessionBrowserUI`, `BoneSpec`, `Color`, `JerseyDesigns.Nations4.cs`, `.Set`, `.Update`, `Turf`, `.ListLobbies`, `ChatCensor`, `StadiumSelectUI`, `Keybinds`, `.SendToAll`, `.BuildFootballer`, `.Set`, `.Build`, `Goal`, `AssetImportRules`, `Body`, `.SendQuickChat`, `.DriveTowardRotation`, `.HandleModelDrag`, `SaveWatch`, `JerseyDesigns.Nations10.cs`, `IPlayerController`, `JerseyDesigns.Nations4.cs`, `JerseyDesigns.Nations5.cs`, `JerseyDesigns.Nations6.cs`, `JerseyDesigns.Nations9.cs`, `NetBackstop.cs`, `Role.cs`, `.Configure`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `NetSession` connect `.Update` to `AccuracyGame`, `.SendQuickChat`, `Goalkeeper AI & Control`, `List`, `.Empty`, `ShotServer`, `CustomizeUI`, `.SetLocalInput`, `.Configure`, `.OnGUI`, `GameInput`, `.Set`, `MenuUI`, `NetSetPieceMatch`, `Goal`, `.ClientUpdate`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `NetPump` to `Net Messages & Wire Codec`, `Input & Keybinds`, `.OptionGrid`, `AccuracyGame`, `SaveWatch`, `LobbyUI`, `BodyLayoutDef`, `OptionsMenu`, `PrematchUI`, `.Configure`, `.OnGUI`, `NetSetPieceMatch`, `INetTransport`, `.ClientUpdate`, `Dribble`, `Footballer`, `.Configure`, `NetCodec`, `Vector3`, `.Box`, `.SetLocalInput`, `GameInput`, `IStrikerInput`, `MenuUI`, `SimConfig`, `.SlotSubMenu`, `com.unity.modules.ui`, `MenuUI`, `JerseyDesigns.Nations10.cs`, `Bone`, `DefensiveWall`, `CrosserControl`, `Role.cs`, `.Begin`, `.StartRebind`, `BoneSpec`, `Color`, `ChatCensor`, `Keybinds`, `.Set`, `.Build`?**
