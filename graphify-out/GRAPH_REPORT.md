...
Cohesion: 0.06
Nodes (23): byte, Vector2, GameInput, float, Transform, Vector3, GameCamera, Mode (+15 more)
...
Cohesion: 0.08
Nodes (15): float, Material, Transform, Vector3, AimReticle, bool, Camera, float (+7 more)
...
Cohesion: 0.05
Nodes (25): Vector2, IStrikerInput, bool, float, int, Rigidbody, BallController, BodyTouch (+17 more)
...
### Community 123 - "Cosmetics"
Cohesion: 0.20
Nodes (10): AccessoryEntry, float, IReadOnlyList, List, Material, Transform, Vector3, Cosmetics (+2 more)
...
### Community 138 - "HairEntry"
Cohesion: 0.25
Nodes (9): Action, bool, Mesh, string, AccessoryEntry, FacialEntry, GeneratedMeshOwner, HairEntry (+1 more)

### Community 139 - "ChatCensor"
Cohesion: 0.38
...
- **Why does `Trickshot` connect `AccuracyGame` to `Jersey / Nation Designs`, `Dribble System`, `Input & Keybinds`, `Goalkeeper AI & Control`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `BodyLayoutDef`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `Bone`, `.Box`, `.OnGUI`, `Celebration`, `SkillTree`, `Footballer`, `SteamTransport`, `com.unity.modules.jsonserialize`, `INetTransport`, `.ClientUpdate`, `Dribble`, `.Configure`, `.Empty`, `NetCodec`, `Footballer`, `SessionBrowserUI`, `.Empty`, `.Box`, `.SetLocalInput`, `.Build`, `GameInput`, `QuickChat`, `IStrikerInput`, `MenuUI`, `SimConfig`, `CrosserBubble`, `AccuracyGame`, `QuickChat`, `com.unity.modules.adaptiveperformance`, `Snapshot`, `MenuUI`, `.PhysMat`, `JerseyDesigns.Nations10.cs`, `StadiumStyle`, `.Set`, `DefensiveWall`, `CrosserControl`, `.StartRebind`, `.Begin`, `FreeplayGame`, `SessionBrowserUI`, `.StartRebind`, `BoneSpec`, `AccuracyBoard`, `JerseyDesigns.Nations4.cs`, `.Set`, `.Update`, `Turf`, `.ListLobbies`, `.AttachKickDetectors`, `StadiumSelectUI`, `.SlotSubMenu`, `.ListLobbies`, `.BuildFootballer`, `MenuUI`, `StadiumSelectUI`, `Goal`, `AssetImportRules`, `.Set`, `.OptionGrid`, `KeeperHands`, `JerseyDesigns.Nations6.cs`, `JerseyDesigns.Nations1.cs`, `HairEntry`, `ChatCensor`, `IPlayerController`, `CrosserBubble`?**
  _High betweenness centrality (0.209) - this node is a cross-community bridge._
- **Why does `NetSession` connect `.Update` to `Footballer`, `.StartRebind`, `Goalkeeper AI & Control`, `BoneSpec`, `Snapshot`, `ShotServer`, `CustomizeUI`, `PlayerAppearance`, `.Set`, `MenuUI`, `NetSetPieceMatch`, `Goal`, `SimConfig`, `.ClientUpdate`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `NetPump` to `Dribble System`, `Net Messages & Wire Codec`, `Input & Keybinds`, `KeeperHands`, `AccuracyGame`, `.Tick`, `LobbyUI`, `JerseyDesigns.Nations1.cs`, `BodyLayoutDef`, `PrematchUI`, `Bone`, `CrosserBubble`, `NetSetPieceMatch`, `com.unity.modules.jsonserialize`, `INetTransport`, `.ClientUpdate`, `Dribble`, `.Configure`, `NetCodec`, `.Configure`, `Footballer`, `Crowd`, `.Box`, `Goalkeeper`, `.SetLocalInput`, `QuickChat`, `IStrikerInput`, `MenuUI`, `SimConfig`, `com.unity.modules.ui`, `AccuracyGame`, `Snapshot`, `MenuUI`, `JerseyDesigns.Nations10.cs`, `DefensiveWall`, `CrosserControl`, `Role.cs`, `.Begin`, `BoneSpec`, `AccuracyBoard`, `MenuUI`?**
