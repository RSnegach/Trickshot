...
## Corpus Check
- 153 files · ~676,527 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3170 nodes · 7922 edges · 158 communities (135 shown, 23 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 781 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4dd1b1bb`
...
1. `ActiveRagdoll` - 162 edges
2. `Trickshot` - 128 edges
3. `NetSession` - 101 edges
4. `BallController` - 97 edges
5. `MatchGame` - 94 edges
...
Cohesion: 0.07
Nodes (17): Rigidbody, Rigidbody, bool, Bounds, byte, Collider, ConfigurableJoint, Dictionary (+9 more)
...
Cohesion: 0.15
Nodes (4): Color, Quaternion, Quaternion, Vector3

### Community 33 - ".Configure"
Cohesion: 0.11
Nodes (10): IPlayerController, bool, float, Func, Quaternion, Vector2, Vector3, KeeperController (+2 more)
...
### Community 35 - ".Empty"
Cohesion: 0.07
Nodes (18): byte, Vector2, GameInput, Texture2D, Action, Camera, Material, Transform (+10 more)
...
### Community 46 - ".Empty"
Cohesion: 0.12
Nodes (11): bool, float, int, Random, string, Vector3, FreeKickGame, Outcome (+3 more)
...
Cohesion: 0.07
Nodes (14): bool, Dictionary, float, Func, HashSet, int, List, string (+6 more)

### Community 59 - "AccuracyBoard"
Cohesion: 0.13
Nodes (7): float, int, Matrix4x4, MenuScale, Action, GUIStyle, Rect
...
Cohesion: 0.07
Nodes (21): bool, List, RuntimeInitializeOnLoadMethod, Multiplayer, NetPumpRunner, Action, bool, float (+13 more)
...
Cohesion: 0.06
Nodes (32): ActiveRagdoll, AimReticle, AnimState, bool, float, GameInput, int, NetSession (+24 more)
...
Cohesion: 0.12
Nodes (11): Action, bool, List, string, SteamFriendInfo, SteamFriendsAPI, Action, List (+3 more)
...
Cohesion: 0.05
Nodes (26): Vector2, IStrikerInput, bool, Collision, float, int, Rigidbody, Vector3 (+18 more)
...
Cohesion: 0.14
Nodes (7): Action, bool, float, NetSession, string, LobbyUI, Color

### Community 120 - "IPlayerController"
Cohesion: 0.25
Nodes (3): int, string, QuickChat

### Community 121 - "Body"
Cohesion: 0.16
Nodes (12): Refs, Color, GameObject, Material, PhysicsMaterial, Texture2D, Transform, Vector3 (+4 more)
...
Cohesion: 0.15
Nodes (8): Action, bool, GameInput, int, MenuUI, Phase, CareerStatsUI, OptionsMenu

### Community 128 - ".Configure"
Cohesion: 0.22
Nodes (7): int, RebindingOperation, string, Vector2, OptionsMenu, Tab, Tab

### Community 131 - "PitchLayout"
Cohesion: 0.10
Nodes (11): NetPump, GoalFrame, Action, MatchModeUI, Action, MultiplayerHubUI, NetAccuracyMatch, NetBackstop (+3 more)
...
Cohesion: 0.11
Nodes (13): SteamAchievementsAPI, Action, Rect, AchievementsPanelUI, int, List, string, AchievementDef (+5 more)
...
## Knowledge Gaps
- **180 isolated node(s):** `Phase`, `Problem`, `Ideas so far`, `Open questions (not answered yet)`, `Reason` (+175 more)
...
- **Why does `Trickshot` connect `AccuracyGame` to `Jersey / Nation Designs`, `Dribble System`, `Net Messages & Wire Codec`, `Input & Keybinds`, `Goalkeeper AI & Control`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `BodyLayoutDef`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `.Box`, `Footballer`, `SteamTransport`, `com.unity.modules.jsonserialize`, `INetTransport`, `Dribble`, `.Configure`, `PitchBuilder`, `.Empty`, `NetCodec`, `.Configure`, `SessionBrowserUI`, `Vector3`, `SessionBrowserUI`, `.Empty`, `.Box`, `Goalkeeper`, `.SetLocalInput`, `.Build`, `KickDetector`, `IStrikerInput`, `AccuracyBoard`, `SimConfig`, `.SlotSubMenu`, `com.unity.modules.ui`, `AccuracyGame`, `com.unity.modules.adaptiveperformance`, `.Heavy`, `AccuracyGame`, `.AddVelocityToAll`, `.SetLocalInput`, `.Box`, `NetPump`, `FlexNet`, `.Begin`, `FreeplayGame`, `.AttachKickDetectors`, `Bone`, `SurroundBuilder`, `IPlayerController`, `BoneSpec`, `Color`, `JerseyDesigns.Nations4.cs`, `.Set`, `SaveWatch`, `Turf`, `.ListLobbies`, `.Update`, `.SetLocalInput`, `QuickChat`, `JerseyDesigns.Nations2.cs`, `JerseyDesigns.Nations7.cs`, `IPlayerController`, `Body`, `ChatCensor`, `GameInput`, `.Divider`, `.Configure`, `AssetImportRules`, `PitchLayout`, `KickDetector`, `CrosserBubble`, `.Begin`, `.ListLobbies`, `Goal`, `.Mul`, `UIFont`, `SteamAchievementsAPI.cs`, `OtherModesUI`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `Celebration` to `Net Messages & Wire Codec`, `PitchLayout`, `CrosserBubble`, `.Begin`, `AccuracyGame`, `Vector3`, `LobbyUI`, `BodyLayoutDef`, `.Configure`, `OptionsMenu`, `NetSetPieceMatch`, `INetTransport`, `.ClientUpdate`, `Dribble`, `Footballer`, `.Configure`, `PitchBuilder`, `NetCodec`, `.Configure`, `SessionBrowserUI`, `.Empty`, `.Box`, `.SetLocalInput`, `GameInput`, `IStrikerInput`, `MenuUI`, `.AddVelocityToAll`, `.SetLocalInput`, `.Box`, `NetPump`, `Role.cs`, `.Begin`, `Color`, `SaveWatch`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `NetSession` connect `SkillTree` to `.Empty`, `GameInput`, `Goalkeeper AI & Control`, `NetSetPieceMatch`, `Footballer`, `SetPieceMap`, `Bone`, `CustomizeUI`, `KeeperHands`, `.Set`, `PeerId`, `IPlayerController`, `.ClientUpdate`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **What connects `Phase`, `Problem`, `Ideas so far` to the rest of the system?**
