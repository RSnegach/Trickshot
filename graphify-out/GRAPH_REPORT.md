...
## Corpus Check
- 147 files · ~673,001 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3087 nodes · 7988 edges · 143 communities (132 shown, 11 thin omitted)
...
### Community 92 - "Goal"
Cohesion: 0.17
Nodes (5): Action, bool, byte, float, SpeciesSelectUI
...
Cohesion: 0.14
Nodes (8): NetPump, GoalFrame, Action, MatchModeUI, NetBackstop, Action, StadiumSelectUI, MonoBehaviour
...
- **Why does `Trickshot` connect `AccuracyGame` to `.Configure`, `AssetImportRules`, `Jersey / Nation Designs`, `Net Messages & Wire Codec`, `Input & Keybinds`, `CrosserBubble`, `IPlayerController`, `Dribble System`, `.TickNetPass`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `Goal`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `Bone`, `Vector3`, `.Box`, `UIFont`, `OtherModesUI`, `BodyLayoutDef`, `Footballer`, `SteamTransport`, `.Join`, `com.unity.modules.jsonserialize`, `INetTransport`, `Dribble`, `Footballer`, `Goalkeeper AI & Control`, `.Empty`, `NetCodec`, `.Configure`, `.Set`, `Vector3`, `SessionBrowserUI`, `.Box`, `Goalkeeper`, `ShotServer`, `.Build`, `GameInput`, `KickDetector`, `SimConfig`, `.SlotSubMenu`, `.Mul`, `AccuracyGame`, `List`, `com.unity.modules.adaptiveperformance`, `.Heavy`, `JerseyDesigns.Nations10.cs`, `AccuracyGame`, `Bone`, `KeeperHands`, `Goal`, `CrosserControl`, `NetPump`, `FlexNet`, `.Begin`, `FreeplayGame`, `.AttachKickDetectors`, `SessionBrowserUI`, `SurroundBuilder`, `IPlayerController`, `BoneSpec`, `Color`, `JerseyDesigns.Nations4.cs`, `.Set`, `SaveWatch`, `Turf`, `.ListLobbies`, `.Update`, `.SetLocalInput`, `.ListLobbies`, `IPlayerController`, `.BuildFootballer`, `GameInput`?**
  _High betweenness centrality (0.215) - this node is a cross-community bridge._
- **Why does `NetSession` connect `SkillTree` to `PitchBuilder`, `.Empty`, `Goalkeeper AI & Control`, `AccuracyGame`, `NetSetPieceMatch`, `SessionBrowserUI`, `Footballer`, `SetPieceMap`, `.Update`, `CustomizeUI`, `TimeTrialGame`, `com.unity.modules.imageconversion`, `.Set`, `.SetLocalInput`, `.ClientUpdate`, `LobbyUI`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `Celebration` to `Net Messages & Wire Codec`, `Input & Keybinds`, `CrosserBubble`, `.TickNetPass`, `AccuracyGame`, `Vector3`, `LobbyUI`, `BodyLayoutDef`, `OptionsMenu`, `OtherModesUI`, `.Join`, `NetSetPieceMatch`, `INetTransport`, `.ClientUpdate`, `Footballer`, `.Configure`, `.Empty`, `IStrikerInput`, `MenuUI`, `SimConfig`, `MenuUI`, `TimeTrialGame`, `AccuracyGame`, `KeeperHands`, `CrosserControl`, `NetPump`, `Role.cs`, `FlexNet`, `.Begin`, `.AttachKickDetectors`, `Color`, `SaveWatch`, `.SetLocalInput`, `ShotServer`, `BodyLayoutDef`, `.AddVelocityToAll`, `Body`, `.BuildFootballer`?**
