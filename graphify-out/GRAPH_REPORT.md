...
Cohesion: 0.17
Nodes (7): bool, float, int, string, KeeperGame, float, SaveWatch
...
Cohesion: 0.13
Nodes (10): Dictionary, HashSet, IEnumerable, List, Category, SkillTree, Category, ICollection (+2 more)
...
Cohesion: 0.19
Nodes (6): Vector2, IStrikerInput, bool, float, Func, CrosserControl
...
Cohesion: 0.09
Nodes (15): AnimState, bool, float, int, string, uint, Vector3, Body (+7 more)
...
Cohesion: 0.12
Nodes (9): IPlayerController, bool, float, Func, Quaternion, Vector2, Vector3, KeeperController (+1 more)
...
Cohesion: 0.16
Nodes (10): Action, int, Texture2D, UITheme, Color, GUISkin, GUIStyle, Rect (+2 more)

### Community 43 - "Footballer"
Cohesion: 0.07
Nodes (18): bool, float, Quaternion, Transform, Vector3, Crosser, Camera, Color (+10 more)
...
Cohesion: 0.09
Nodes (13): float, Material, Transform, Vector3, AimReticle, Refs, bool, float (+5 more)
...
Cohesion: 0.15
Nodes (12): ActiveRagdoll, AimReticle, GameInput, BallController, Camera, Crosser, GameCamera, GameInput (+4 more)
...
Cohesion: 0.10
Nodes (17): Transform, bool, Camera, float, Func, Transform, Vector3, GameCamera (+9 more)
...
Cohesion: 0.18
Nodes (3): Snapshot, BodyState, LobbyAdvert
...
Cohesion: 0.16
Nodes (10): Color, GameObject, Material, Texture2D, Transform, Vector3, JerseyFaces, Make (+2 more)
...
Cohesion: 0.06
Nodes (15): Collision, float, KickDetector, Rigidbody, Rigidbody, bool, Collider, float (+7 more)
...
Cohesion: 0.06
Nodes (22): bool, float, int, Snapshot, string, uint, Vector3, JerseyRx (+14 more)
...
Cohesion: 0.17
Nodes (6): Action, bool, int, MenuUI, Phase, Phase

### Community 124 - ".BuildFootballer"
Cohesion: 0.15
Nodes (10): int, Texture2D, TitleGlyph, ConfigurableJoint, Quaternion, Rigidbody, Vector3, JointMath (+2 more)
...
### Community 133 - "IPlayerController"
Cohesion: 0.20
...
- **Why does `Trickshot` connect `AccuracyGame` to `Goal`, `AssetImportRules`, `Jersey / Nation Designs`, `Dribble System`, `Input & Keybinds`, `.Set`, `JerseyDesigns.Nations6.cs`, `.OptionGrid`, `JerseyDesigns.Nations1.cs`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `BodyLayoutDef`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `Bone`, `.Box`, `.OnGUI`, `Celebration`, `SkillTree`, `Footballer`, `CrosserBubble`, `SteamTransport`, `com.unity.modules.jsonserialize`, `INetTransport`, `Dribble`, `Goalkeeper AI & Control`, `.Empty`, `NetCodec`, `.Configure`, `Footballer`, `SessionBrowserUI`, `.Empty`, `.Box`, `Goalkeeper`, `.SetLocalInput`, `.Build`, `GameInput`, `QuickChat`, `IStrikerInput`, `MenuUI`, `SimConfig`, `CrosserBubble`, `QuickChat`, `com.unity.modules.adaptiveperformance`, `MenuUI`, `.PhysMat`, `JerseyDesigns.Nations10.cs`, `.Set`, `CrosserControl`, `Role.cs`, `.StartRebind`, `.Begin`, `SessionBrowserUI`, `.StartRebind`, `BoneSpec`, `AccuracyBoard`, `JerseyDesigns.Nations4.cs`, `.Set`, `.Update`, `Turf`, `.ListLobbies`, `PlayerAppearance`, `.AttachKickDetectors`, `StadiumSelectUI`, `ChatCensor`, `.ListLobbies`, `KickDetector`, `.BuildFootballer`, `MenuUI`, `StadiumSelectUI`?**
  _High betweenness centrality (0.243) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `NetPump` to `Net Messages & Wire Codec`, `Input & Keybinds`, `IPlayerController`, `AccuracyGame`, `JerseyDesigns.Nations1.cs`, `LobbyUI`, `BodyLayoutDef`, `PrematchUI`, `Bone`, `CrosserBubble`, `NetSetPieceMatch`, `INetTransport`, `.Configure`, `NetCodec`, `.Configure`, `Footballer`, `Crowd`, `QuickChat`, `IStrikerInput`, `MenuUI`, `SimConfig`, `AccuracyGame`, `Snapshot`, `MenuUI`, `JerseyDesigns.Nations10.cs`, `StadiumStyle`, `Bone`, `.Set`, `CrosserControl`, `Role.cs`, `.Begin`, `BoneSpec`, `AccuracyBoard`, `.Configure`, `MenuUI`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `Trickshot.Net` connect `AccuracyGame` to `Footballer`, `SkillTree`, `PlayerPreview`, `.Tick`, `.Heavy`, `ShotServer`, `com.unity.modules.imageconversion`, `.Set`, `MenuUI`?**
