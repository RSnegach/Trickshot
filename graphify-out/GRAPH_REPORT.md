...
## Corpus Check
- 154 files · ~677,935 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3595 nodes · 9120 edges · 163 communities (149 shown, 12 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 857 edges (avg confidence: 0.81)
...
### Community 12 - "SlotKind"
Cohesion: 0.11
Nodes (17): BodyPlan, Biped, Quadruped, HeaderAction, Biped, SlotKind, Skin, StyleA (+9 more)
...
Cohesion: 0.15
Nodes (9): Func, Quaternion, Vector3, Goalkeeper, Body, HasBall, PelvisPos, WasDivingSave (+1 more)

### Community 15 - ".Box"
Cohesion: 0.13
Nodes (15): Collider, Color, Material, Transform, Vector3, Crowd, FanCount, CrowdCheer (+7 more)
...
Cohesion: 0.05
Nodes (36): Collider, Transform, CrosserBubble, Bounds, BoxCollider, CapsuleCollider, Collider, ConfigurableJoint (+28 more)

### Community 23 - "NetSession"
Cohesion: 0.04
Nodes (41): appr, PeerId, IsValid, JerseyChunkMsg, LobbySlot, NetRole, Crosser, Keeper (+33 more)
...
Cohesion: 0.09
Nodes (9): Goalkeeper, List, Material, ShootoutState, Snapshot, Transform, Vector3, Body (+1 more)
...
Cohesion: 0.09
Nodes (11): Stage, Body, Jersey, Name, Skill, Crosser, Material, Transform (+3 more)
...
### Community 32 - "Emote"
Cohesion: 0.05
Nodes (44): Action, e, name, Vector3, Celebration, CurrentEmote, Playing, Progress01 (+36 more)
...
Cohesion: 0.11
Nodes (10): Transform, Vector3, GameManager, CrossMapEscapeOwned, SaveWatch, Armed, Epic, Touched (+2 more)

### Community 35 - "Striker"
Cohesion: 0.17
Nodes (7): Striker, Collision, KickDetector, Rigidbody, Rigidbody, Rigidbody, Rigidbody
...
Cohesion: 0.08
Nodes (12): Dictionary, ChatCensor, QuickChat, Slots, List, Queue, Line, QuickChatFeed (+4 more)
...
Cohesion: 0.11
Nodes (16): Func, Quaternion, Vector3, SetPieceTaker, Active, Done, HasCharged, IsCharging (+8 more)
...
### Community 54 - ".Scrim"
Cohesion: 0.09
Nodes (14): Matrix4x4, MenuScale, Active, Factor, Height, UserScale, Width, MenuUI (+6 more)
...
Cohesion: 0.06
Nodes (29): Vector2, IStrikerInput, CloseControlHeld, EmoteId, Fresh, JumpHeld, JumpPressed, JumpReleased (+21 more)
...
Cohesion: 0.09
Nodes (31): Action, Rect, Action, Rect, GUIStyle, Color, GUIStyle, Matrix4x4 (+23 more)
...
Cohesion: 0.08
Nodes (12): InputFrame, Vector2, InputFrame, StatRow, Texture2D, Bar, Material, Refs (+4 more)

### Community 82 - "NetInputSource"
Cohesion: 0.07
Nodes (27): Vector2, NetInputSource, CloseControlHeld, EmoteId, Fresh, JumpHeld, JumpPressed, JumpReleased (+19 more)
...
### Community 98 - ".Build"
Cohesion: 0.23
Nodes (13): IEnumerable, Quaternion, Vector3, Seat, Collider, Color, Material, PhysicsMaterial (+5 more)
...
### Community 103 - ".Build"
Cohesion: 0.24
Nodes (11): NetBackstop, Collider, Material, MeshFilter, MeshRenderer, PhysicsMaterial, Renderer, Transform (+3 more)

### Community 104 - "MonoBehaviour"
Cohesion: 0.13
Nodes (12): List, Quaternion, Rigidbody, Transform, Vector3, Frame, ReplaySystem, IsPlaying (+4 more)
...
### Community 123 - "NetMessages.cs"
Cohesion: 0.09
Nodes (20): Vector3, AnimState, Dive, Down, Idle, Jump, Kick, Run (+12 more)

### Community 124 - ".Build"
Cohesion: 0.14
Nodes (18): Outcome, Blocked, Goal, Miss, Save, GoalFrame, Collider, Material (+10 more)
...
Cohesion: 0.22
Nodes (8): Action, GUIStyle, RebindingOperation, Rect, Vector2, OptionsMenu, IsRebinding, Tab

### Community 132 - "CareerStatsData"
Cohesion: 0.73
...
Cohesion: 0.09
Nodes (18): Func, Transform, Vector3, GameCamera, BallCam, KeeperLookDownFraction, KeeperLookYaw, Pitch (+10 more)

### Community 143 - "GameInput"
Cohesion: 0.05
Nodes (39): Vector2, GameInput, BallCamPressed, CloseControlHeld, CrossMapPressed, CursorCaptured, EmoteHeld, EmoteId (+31 more)
...
## Knowledge Gaps
- **817 isolated node(s):** `mcp-for-unity`, `graphify-mcp`, `ZipEnabled`, `CursorCaptured`, `Move` (+812 more)
...
- **Why does `Trickshot` connect `Trickshot` to `CustomizeUI`, `JerseyDesigns`, `SimConfig`, `Dribble`, `SetPieceMap`, `SkillTree`, `SkillIcons`, `Cosmetics`, `HairSim`, `AdultQuiz`, `SlotKind`, `CareerStatsUI`, `.Box`, `MenuIcons`, `AccuracyBoard`, `ActiveRagdoll`, `BuildAll`, `MatchProbe`, `PauseMenu`, `Passing`, `Bone`, `Emote`, `KeeperController`, `GameManager`, `Striker`, `AnatomySim`, `AccuracyGame`, `QuickChatFeed`, `AimReticle`, `CrossMap`, `FreeKickGame`, `SetPieceTaker`, `Keybinds`, `.DestroyNetworkedUI`, `SkyDome`, `PropKit`, `.Scrim`, `AccuracyTarget`, `MatchGame`, `IStrikerInput`, `FlexNet`, `Sniper`, `DefensiveWall`, `UITheme`, `TitleGlyph`, `AudioManager`, `DisplaySettings`, `Footballer`, `StatRadar`, `.Pose`, `PitchLayout`, `PlayerPreview`, `Knockdown`, `.Build`, `.RequestFriendsList`, `.Build`, `.SlotSubMenu`, `.Build`, `MonoBehaviour`, `.SetPoseOverride`, `MenuBackground`, `.Place`, `Turf`, `StadiumStyle`, `ShotServer`, `.Draw`, `KeeperGame`, `Make`, `.Build`, `Goal`, `OptionsMenu`, `AssetImportRules`, `CareerStatsData`, `Striker`, `.DriveTowardRotation`, `UIFont`, `GameInput`, `Crosser`, `Achievements`, `ShotType`, `Role`, `NotificationToastUI`, `CallLimiter`?**
  _High betweenness centrality (0.170) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `ActiveRagdoll` to `Dribble`, `Trickshot`, `Striker`, `HairSim`, `SlotKind`, `GameCamera`, `Goalkeeper`, `Crosser`, `.Box`, `.ClearPoseOverrides`, `GameBootstrap`, `NetSetPieceMatch`, `Passing`, `NetStrikerMatch`, `Bone`, `Emote`, `KeeperController`, `GameManager`, `Striker`, `AnatomySim`, `KeeperHands`, `AccuracyGame`, `FreeKickGame`, `SetPieceTaker`, `MatchGame`, `Sniper`, `Footballer`, `NetMatch`, `.Pose`, `PlayerPreview`, `Hud`, `Knockdown`, `MonoBehaviour`, `.SetPoseOverride`, `MenuBackground`, `BallController`, `KeeperGame`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `NetSession` connect `NetSession` to `LobbyUI`, `SkillTree`, `NetSetPieceMatch`, `QuickChatFeed`, `Multiplayer`, `.RouteMessage`, `NetMatch`, `NetWriter`, `MsgType`, `INetTransport`, `GameBootstrap`, `NetMessages.cs`, `NetStrikerMatch`?**
