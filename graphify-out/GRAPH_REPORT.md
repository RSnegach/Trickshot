...
## Corpus Check
- 141 files · ~660,114 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2990 nodes · 7657 edges · 156 communities (131 shown, 25 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 826 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d83c072d`
...
1. `ActiveRagdoll` - 154 edges
2. `Trickshot` - 118 edges
3. `BallController` - 101 edges
4. `ScrimmageGame` - 98 edges
...
Cohesion: 0.12
Nodes (11): Bar, bool, float, List, Vector3, Bar, Option, Passing (+3 more)
...
Cohesion: 0.09
Nodes (21): byte, Vector2, GameInput, bool, Camera, float, Func, Transform (+13 more)
...
### Community 47 - ".Box"
Cohesion: 0.16
Nodes (10): BallController, Bar, Dribble, GameCamera, GameInput, IStrikerInput, KeeperController, Refs (+2 more)
...
Cohesion: 0.11
Nodes (13): AimReticle, PlayerStat, ScrimmageGame, Touch, TouchRec, bool, Celebration, Dictionary (+5 more)
...
Cohesion: 0.07
Nodes (18): Collision, bool, Bounds, byte, Collider, ConfigurableJoint, Dictionary, float (+10 more)
...
Cohesion: 0.06
Nodes (14): Vector2, IStrikerInput, Rigidbody, Rigidbody, Rigidbody, bool, Collider, float (+6 more)
...
Cohesion: 0.05
Nodes (35): bool, Camera, float, Func, int, List, Material, Mesh (+27 more)
...
### Community 132 - ".Set"
Cohesion: 0.36
Nodes (4): Func, List, PlayerStat, StatRow
...
### Community 138 - ".TabBtn"
Cohesion: 0.38
Nodes (4): Vector3, KeeperPose, b, e

### Community 139 - "JerseyDesigns.Nations9.cs"
Cohesion: 0.38
...
## Knowledge Gaps
- **177 isolated node(s):** `Touch`, `Reason`, `Phase`, `SetPieceSpin`, `Emote` (+172 more)
...
- **Why does `Trickshot` connect `AccuracyGame` to `Goal`, `AssetImportRules`, `Jersey / Nation Designs`, `.Set`, `Input & Keybinds`, `.Set`, `IPlayerController`, `JerseyDesigns.Nations1.cs`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `BodyLayoutDef`, `.TabBtn`, `JerseyDesigns.Nations9.cs`, `PrematchUI`, `Bone`, `SetPieceTaker`, `.Box`, `.OnGUI`, `Celebration`, `SkillTree`, `Footballer`, `SteamTransport`, `com.unity.modules.jsonserialize`, `INetTransport`, `Dribble`, `Footballer`, `.Configure`, `.Empty`, `NetCodec`, `.Configure`, `Footballer`, `Crowd`, `SessionBrowserUI`, `.Empty`, `Goalkeeper`, `.SetLocalInput`, `.Build`, `GameInput`, `IStrikerInput`, `MenuUI`, `com.unity.modules.ui`, `CrosserBubble`, `AccuracyGame`, `com.unity.modules.adaptiveperformance`, `MenuUI`, `.PhysMat`, `JerseyDesigns.Nations10.cs`, `StadiumStyle`, `.Set`, `DefensiveWall`, `CrosserControl`, `.StartRebind`, `.Begin`, `FreeplayGame`, `AimReticle`, `SessionBrowserUI`, `.StartRebind`, `BoneSpec`, `JerseyDesigns.Nations4.cs`, `.Set`, `.Update`, `Turf`, `.ListLobbies`, `.Update`, `.Mul`, `.ListLobbies`, `KickDetector`, `.TabBtn`, `ChatCensor`, `.Set`?**
  _High betweenness centrality (0.193) - this node is a cross-community bridge._
- **Why does `NetSession` connect `QuickChat` to `PitchBuilder`, `MenuUI`, `AccuracyGame`, `AccuracyBoard`, `JerseyDesigns.Nations2.cs`, `BoneSpec`, `Snapshot`, `.Heavy`, `.Mul`, `CustomizeUI`, `StadiumSelectUI`, `.Set`, `.Join`, `NetSetPieceMatch`, `Goal`, `SimConfig`, `.ClientUpdate`, `.Set`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `NetPump` to `Net Messages & Wire Codec`, `Input & Keybinds`, `IPlayerController`, `AccuracyGame`, `JerseyDesigns.Nations1.cs`, `LobbyUI`, `Direct IP Transport`, `BodyLayoutDef`, `Color`, `PrematchUI`, `Bone`, `.Box`, `NetSetPieceMatch`, `INetTransport`, `.ClientUpdate`, `Footballer`, `.Configure`, `PitchBuilder`, `NetCodec`, `Footballer`, `Crowd`, `ShotServer`, `.SetLocalInput`, `MenuUI`, `AccuracyGame`, `Snapshot`, `MenuUI`, `JerseyDesigns.Nations10.cs`, `Bone`, `CrosserControl`, `Role.cs`, `.Begin`, `FreeplayGame`, `BoneSpec`, `AccuracyBoard`, `JerseyDesigns.Nations4.cs`, `.Update`, `.Mul`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **What connects `Touch`, `Reason`, `Phase` to the rest of the system?**
