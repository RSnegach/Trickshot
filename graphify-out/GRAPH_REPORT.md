...
## Corpus Check
- 109 files · ~237,700 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2094 nodes · 5164 edges · 114 communities (97 shown, 17 thin omitted)
...
Cohesion: 0.05
Nodes (20): bool, float, Vector3, Dribble, bool, float, int, Vector3 (+12 more)

### Community 3 - "Net Messages & Wire Codec"
Cohesion: 0.07
Nodes (20): Action, List, INetTransport, PeerId, NetRole, bool, byte, Dictionary (+12 more)
...
Cohesion: 0.07
Nodes (20): bool, Camera, float, int, List, Material, string, Transform (+12 more)
...
Cohesion: 0.12
Nodes (14): InputFrame, bool, byte, float, string, uint, BodyState, InputFrame (+6 more)

### Community 29 - "INetTransport"
Cohesion: 0.13
Nodes (8): bool, float, int, string, Transform, Vector3, GameManager, Vector3
...
Cohesion: 0.07
Nodes (20): bool, Collision, float, Rigidbody, Vector3, BallController, SetPieceSpin, Collision (+12 more)
...
Cohesion: 0.22
Nodes (5): Vector2, IStrikerInput, bool, Vector2, NetInputSource
...
### Community 95 - "KickDetector"
Cohesion: 0.33
Nodes (3): Action, float, KickDetector
...
Cohesion: 0.15
Nodes (3): NetChannel, List, SteamTransport
...
- **Why does `Trickshot` connect `AccuracyGame` to `Jersey / Nation Designs`, `Dribble System`, `Input & Keybinds`, `Goalkeeper AI & Control`, `Direct IP Transport`, `Net Set-Piece Match`, `SkillIcons`, `SetPieceTaker`, `OptionsMenu`, `Bone`, `Striker`, `CustomizeUI`, `GameCamera`, `Celebration`, `SkillTree`, `SteamTransport`, `NetStrikerMatch`, `NetSetPieceMatch`, `INetTransport`, `BallController`, `Footballer`, `Footballer`, `.Empty`, `Dribble`, `Crosser`, `Multiplayer`, `.Box`, `.Empty`, `GameCamera`, `MenuBackground`, `.Cylinder`, `QuickChat`, `.SetLocalInput`, `INetTransport`, `.Box`, `DefensiveWall`, `AccuracyGame`, `com.unity.modules.adaptiveperformance`, `.StartRebind`, `.ResetTo`, `.Build`, `JerseyDesigns.Nations2.cs`, `com.unity.modules.wind`, `OptionsMenu`, `.Set`, `JerseyDesigns.Nations4.cs`, `JerseyDesigns.Nations9.cs`, `ShotType.cs`, `PauseMenu`, `KickDetector`, `Crowd`, `MenuUI`, `QuickChat`, `IPlayerController`, `JerseyDesigns.Nations10.cs`, `JerseyDesigns.Nations2.cs`, `JerseyDesigns.Nations3.cs`, `Knockdown`, `StadiumStyle`, `Goal`, `JerseyDesigns.Nations5.cs`, `JerseyDesigns.Nations7.cs`, `JerseyDesigns.Nations8.cs`, `JerseyDesigns.Nations9.cs`?**
  _High betweenness centrality (0.187) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `PrematchUI` to `Dribble System`, `Input & Keybinds`, `AccuracyGame`, `Kick Detection / Ragdoll Wiring`, `SkillIcons`, `SetPieceTaker`, `SkillTree`, `KeeperGame`, `SteamTransport`, `NetSetPieceMatch`, `INetTransport`, `BallController`, `Footballer`, `LocalTransport`, `Multiplayer`, `.SafeEncode`, `.ClientUpdate`, `.Box`, `.Empty`, `GameCamera`, `INetTransport`, `.Box`, `DefensiveWall`, `KickDetector`, `Knockdown`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `NetSession` connect `Net Messages & Wire Codec` to `ChatCensor`, `NetCodec`, `Direct IP Transport`, `AccuracyGame`, `Kick Detection / Ragdoll Wiring`, `.SafeEncode`, `.ClientUpdate`, `GameMode`, `KeeperGame`, `com.unity.modules.jsonserialize`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
