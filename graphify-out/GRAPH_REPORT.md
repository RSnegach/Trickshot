...
## Corpus Check
- 141 files · ~659,822 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2965 nodes · 7735 edges · 140 communities (130 shown, 10 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 858 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e0203b00`
...
## Communities (140 total, 10 thin omitted)
...
Cohesion: 0.10
Nodes (12): Vector2, IStrikerInput, float, Func, CrosserControl, Action, bool, float (+4 more)
...
Cohesion: 0.10
Nodes (5): PeerId, JoinRefusal, NetRole, PlayerAppearance, IEquatable
...
Cohesion: 0.09
Nodes (12): bool, Camera, float, GameObject, int, Light, Material, Quaternion (+4 more)
...
Cohesion: 0.08
Nodes (15): StatRow, bool, byte, Dictionary, float, HashSet, int, Queue (+7 more)
...
Cohesion: 0.07
Nodes (22): Color, float, Rect, Vector2, Vector3, CrossMap, bool, Camera (+14 more)
...
Cohesion: 0.10
Nodes (12): float, int, Matrix4x4, Rect, Vector2, MenuScale, Action, bool (+4 more)
...
### Community 133 - ".Set"
Cohesion: 0.09
Nodes (13): byte, Vector2, GameInput, Action, bool, MenuUI, Camera, Material (+5 more)

### Community 137 - "JerseyDesigns.Nations2.cs"
Cohesion: 0.11
...
- **Why does `Trickshot` connect `AccuracyGame` to `Ball Physics & Launch`, `AssetImportRules`, `Goal`, `Net Messages & Wire Codec`, `Jersey / Nation Designs`, `.Set`, `Input & Keybinds`, `.Set`, `JerseyDesigns.Nations1.cs`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `.Set`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `.Box`, `.OnGUI`, `Celebration`, `SkillTree`, `Footballer`, `SteamTransport`, `.Join`, `com.unity.modules.jsonserialize`, `INetTransport`, `Goalkeeper AI & Control`, `Footballer`, `.Configure`, `.Empty`, `NetCodec`, `.Configure`, `Footballer`, `Crowd`, `SessionBrowserUI`, `.Empty`, `.Box`, `Goalkeeper`, `ShotServer`, `.SetLocalInput`, `.Build`, `GameInput`, `MenuUI`, `SimConfig`, `com.unity.modules.ui`, `CrosserBubble`, `AccuracyGame`, `com.unity.modules.adaptiveperformance`, `Snapshot`, `.PhysMat`, `JerseyDesigns.Nations10.cs`, `StadiumStyle`, `.Set`, `DefensiveWall`, `CrosserControl`, `Role.cs`, `.StartRebind`, `.Begin`, `FreeplayGame`, `AimReticle`, `SessionBrowserUI`, `.StartRebind`, `JerseyDesigns.Nations4.cs`, `.Set`, `.Update`, `Turf`, `.ListLobbies`, `.Update`, `StadiumSelectUI`, `.ListLobbies`, `KickDetector`, `.TabBtn`, `ChatCensor`, `.Set`?**
  _High betweenness centrality (0.195) - this node is a cross-community bridge._
- **Why does `NetSession` connect `QuickChat` to `QuickChat`, `Goalkeeper AI & Control`, `AccuracyBoard`, `BodyLayoutDef`, `Snapshot`, `.Heavy`, `CustomizeUI`, `.ClientUpdate`, `MenuUI`, `NetSetPieceMatch`, `Goal`, `SimConfig`, `.BeginTurn`, `Dribble`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `NetPump` to `Net Messages & Wire Codec`, `Input & Keybinds`, `Goalkeeper AI & Control`, `AccuracyGame`, `JerseyDesigns.Nations2.cs`, `LobbyUI`, `JerseyDesigns.Nations1.cs`, `OptionsMenu`, `PrematchUI`, `Bone`, `NetSetPieceMatch`, `INetTransport`, `.ClientUpdate`, `Footballer`, `.Configure`, `PitchBuilder`, `NetCodec`, `Footballer`, `Crowd`, `Goalkeeper`, `ShotServer`, `.SetLocalInput`, `IStrikerInput`, `MenuUI`, `SimConfig`, `AccuracyGame`, `Snapshot`, `MenuUI`, `JerseyDesigns.Nations10.cs`, `CrosserControl`, `Role.cs`, `.StartRebind`, `.Begin`, `FreeplayGame`, `.Update`, `.Mul`, `StadiumSelectUI`, `.BeginTurn`?**
