...
## Corpus Check
- 147 files · ~671,229 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3075 nodes · 7942 edges · 134 communities (125 shown, 9 thin omitted)
...
Cohesion: 0.05
Nodes (17): JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns, JerseyDesigns (+9 more)
...
Cohesion: 0.06
Nodes (23): Collider, float, Transform, CrosserBubble, Rigidbody, Rigidbody, bool, Bounds (+15 more)
...
### Community 35 - ".Empty"
Cohesion: 0.22
Nodes (7): Material, PhysicsMaterial, Transform, Vector3, Arena, Refs, PhysicsMaterialCombine
...
Cohesion: 0.14
Nodes (7): Texture2D, Camera, Material, Transform, Color, Material, Texture2D
...
### Community 87 - "Bone"
Cohesion: 0.15
Nodes (8): bool, float, int, string, Transform, Vector3, GameManager, Mode
...
Cohesion: 0.06
Nodes (31): Collider, Color, float, GameObject, int, Material, Transform, Vector3 (+23 more)
...
Cohesion: 0.12
Nodes (9): NetPump, GoalFrame, Action, MatchModeUI, Action, MultiplayerHubUI, NetAccuracyMatch, NetBackstop (+1 more)
...
Cohesion: 0.09
Nodes (13): bool, int, MenuUI, Phase, Action, GUIStyle, int, RebindingOperation (+5 more)
...
- **Why does `Trickshot` connect `AccuracyGame` to `ChatCensor`, `AssetImportRules`, `Jersey / Nation Designs`, `Net Messages & Wire Codec`, `Input & Keybinds`, `.TickNetPass`, `Dribble System`, `Goalkeeper AI & Control`, `Direct IP Transport`, `LobbyUI`, `Net Set-Piece Match`, `Goal`, `SetPieceTaker`, `OptionsMenu`, `PrematchUI`, `Bone`, `.Box`, `.Mul`, `.Mul`, `Celebration`, `Footballer`, `SteamTransport`, `.Join`, `com.unity.modules.jsonserialize`, `INetTransport`, `Dribble`, `Footballer`, `.Configure`, `PitchBuilder`, `.Empty`, `NetCodec`, `Footballer`, `SessionBrowserUI`, `.Empty`, `.Box`, `Goalkeeper`, `.Build`, `GameInput`, `IStrikerInput`, `SimConfig`, `.SlotSubMenu`, `CrosserBubble`, `AccuracyGame`, `com.unity.modules.adaptiveperformance`, `.Heavy`, `JerseyDesigns.Nations10.cs`, `MultiplayerHubUI`, `Bone`, `Action`, `MenuUI`, `.SetPoseOverride`, `CrosserControl`, `FlexNet`, `.Begin`, `FreeplayGame`, `SessionBrowserUI`, `IPlayerController`, `BoneSpec`, `Color`, `JerseyDesigns.Nations4.cs`, `.Set`, `Turf`, `.ListLobbies`, `.Update`, `.SetLocalInput`, `ShotServer`, `Body`, `.Divider`, `.BuildFootballer`, `MenuUI`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `NetSession` connect `SkillTree` to `Footballer`, `.Configure`, `Goalkeeper AI & Control`, `List`, `SessionBrowserUI`, `SetPieceMap`, `Vector3`, `TimeTrialGame`, `.SetLocalInput`, `CustomizeUI`, `.ClientUpdate`, `.Set`, `NetSetPieceMatch`, `Goal`, `NetPump`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `ActiveRagdoll` connect `Celebration` to `Net Messages & Wire Codec`, `Input & Keybinds`, `.TickNetPass`, `AccuracyGame`, `Vector3`, `LobbyUI`, `BodyLayoutDef`, `OptionsMenu`, `NetSetPieceMatch`, `INetTransport`, `.ClientUpdate`, `Dribble`, `Footballer`, `.Configure`, `.Box`, `Goalkeeper`, `ShotServer`, `.SetLocalInput`, `GameInput`, `IStrikerInput`, `MenuUI`, `SimConfig`, `MenuUI`, `TimeTrialGame`, `Bone`, `CrosserControl`, `Role.cs`, `FlexNet`, `.Begin`, `.AttachKickDetectors`, `Color`, `.Update`, `.SetLocalInput`, `.SendToAll`, `Body`, `.BuildFootballer`?**
